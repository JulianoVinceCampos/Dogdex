...
fun DogDetailScreen(
    ...
    Box(
        ...
        Image(
            ...
            contentDescription = dog.nameDog
        )
...
fun LifeIcon() {
    Row(
        ...
        Surface(
            shape = RoundedCornerShape(bottomEnd = 2.dp, topEnd = 2.dp), modifier = Modifier
                .width(200.dp)
                .height(6.dp), color = colorResource(
...
fun DogDetailScreenPreview() {
    val dog =
        Dog(
            ...
            "70",
            "75",
            "https://firebasestorage.googleapis.com/v0/b/perrodex-app.appspot.com/o/dog",
            "10 - 12",
            "Driendly, playful",
            "5",
            "6"
